...
```{r}
colors <- tolower(c("Grey", "Blue", "Red", "Purple", "Turquoise", "Green", "Gold", "Magenta"))
```
...
plot <- ggplot (branches) +
  ...
  scale_linetype_manual(values = c("solid","12","dotdash", "solid"), 
                        labels = c("Cont", "BPT", "BPP", "Bifurcation")) +
  ...
  guides(linetype = guide_legend(override.aes = list(linetype = c('solid', '14', 'dotdash', 'solid'),
                                                linewidth = c(1.5, 1, 1, 1.5))), 
         fill = "none", 
...
```{r dataset3_plot, fig.height=5, fig.width=10}
plot
```
```{r}
ggsave(plot, filename = "../results/Dataset3_plot/dataset3_plot.svg", width = 10, height = 6 )
ggsave(plot, filename = "../results/Dataset3_plot/dataset3_plot.png", width = 10, height = 6 )
