...
```
```{r}
ggsave(plot, filename = "../results/Dataset2_plot/dataset2_plot.svg", width = 10, height = 6)
ggsave(plot, filename = "../results/Dataset2_plot/dataset2_plot.png", width = 10, height = 6)
```
